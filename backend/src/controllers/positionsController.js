...
export const controller = {
  initializePositions: async (req, res) => {
    try {
      const positionsData = [
        {
          title: "Vet",
        ...
        },
        {
          title: "Caretaker",
          description:
            "Feeds, cleans, and provides daily care for the animals.",
        },
      ];
  ...
  getAllPositions: async (req, res) => {
    try {
      ...
      res
        .status(200)
        .json({ succes: true, count: positions.length, data: positions });
    } catch (error) {
